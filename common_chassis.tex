  ...
  \caption{Перелік деталей шасі}
    %\begin{tabular}{|p{1cm}|p{8cm}|p{3cm}|}
     \begin{tabular}{|p{0.8cm}|p{3.2cm}|p{7.5cm}|p{2cm}|} 
        ...
        2 & 34560-184 & Рельс передній L-KD,84HP & 4 од. \\ \hline
        3 & 34560-163 & Рельс передній L-KD,63HP & 4 од. \\ \hline
        4 & 34560-484 & Рельс задній L-ST,84HP & 2 од. \\ \hline
        5 & 34560-463 & Рельс задній L-ST,63HP & 2 од. \\ \hline
...
\begin{figure}[H]
    \centering
    % Переконайтеся, що файл зображення завантажений в Overleaf
    \includegraphics[width=0.5\textwidth]{images/A22.png} 
...
\begin{figure}[H]
    \centering
    % Переконайтеся, що файл зображення завантажений в Overleaf
    \includegraphics[width=0.5\textwidth]{images/A23.png} 
...
\begin{figure}[H]
    \centering
    % Переконайтеся, що файл зображення завантажений в Overleaf
    \includegraphics[width=0.5\textwidth]{images/A24.png} 
...
\begin{figure}[H]
    \centering
    % Переконайтеся, що файл зображення завантажений в Overleaf
    \includegraphics[width=0.5\textwidth]{images/A25.png} 
...
\begin{figure}[H]
    \centering
    % Переконайтеся, що файл зображення завантажений в Overleaf
    \includegraphics[width=0.5\textwidth]{images/A26.png} 
