...
До таблиці не внесено "Напрямні для плат", 220 мм.(24560-353) та "Екрани EuropacPRO",3U, 220 мм.(34562-762). Кількість цих складових позначено у відповідних розділах по складанню модицікацій приладів.
...
Складання конструктиву шасі треба виконувати на пласкій твердій поверхні, яка з метою унеможливлення механічних пошкоджень деталей має бути вкрита
...
підлоги 0,7-0,75 м.
З метою зберігання товарного зовнішнього вигляду та уникнення подряпин конструктиву корпусів, процесс їхнього складання має відбуватися з використанням тонких, чистих, бавовняних рукавичок з антислизовим малюнком. На рукавичках мають бути відсутні плями бруду та жиру. Зібрані, готові для подальшого використання у технологічному процесі вироби, мають бути загорненими у стрейч плівку, якщо є потреба їхнього зберігання. У разі штабелювання використовувати проміжні шари спанбонда.
З метою уникнення подряпин на конструктиві корпусів у процесі складання, забезпечити розміщення складових таким чином щоб унеможливити їх механічний контакт на місці складання за допомогою використання органайзерів для окремих видів деталей. 
Конструктив шасі корпусу скріплюється з використанням самофіксуючих звинтів TORX із різьбленням М4. Викрутка Т20
