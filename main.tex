...
\begin{titlepage}
    ...
    \begin{spacing}{1.5}
        ...
        {\huge \textbf{КОНСТРУКТИВІВ ШАСІ 3U19'' ТИПУ ''SCHROFF''}} \\
...
% --- ОГЛАВЛЕНИЕ ---
\hypertarget{toc_link}{} 
\tableofcontents
\newpage

% --- ОБЩАЯ ЧАСТЬ ---
\chapter{Збирання базового шасі SCHROFF 3U19''}
...
\IfFileExists{modules/apk_oi rx.tex}{\input{modules/apk_oi rx}}{Опис готується...}

\section{«ОРІОН» АПК TX}
\IfFileExists{modules/apk_tx.tex}{\input{modules/apk_tx}}{Опис готується...}

\section{«ОРІОН» АПК OI TX}
\IfFileExists{modules/apk_oi tx.tex}{\input{modules/apk_oi tx}}{Опис готується...}
