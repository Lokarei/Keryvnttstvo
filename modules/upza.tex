\begin{table}[H]
  ...
  \caption{Перелік деталей шасі}
    \begin{tabular}{|p{0.8cm}|p{3.2cm}|p{7.5cm}|p{2cm}|} 
       ...
       13 & 34562-762 & Екран міжплатний EuropacPRO,3U,220 мм & 3 од. \\ \hline
       ...
       17 & ЕПМ7.001.016 & Екран КП ДФЗ 110 SCHROFF  & 1 од. \\ \hline
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.0\textwidth]{images/A67.png} 
   % \caption{ОРІОН УПЗА тип А}
\end{figure}
\begin{figure}[H]
    \centering
    % Переконайтеся, що файл зображення завантажений в Overleaf
    \includegraphics[width=1.0\textwidth]{images/A6.png} 
    \caption{ОРІОН УПЗА тип А}
\end{figure}

\begin{mybox}{Важливо}
Розташування екранів: 1/20, 2/33, 3/47
\end{mybox}

\begin{mybox}{Важливо}
Розташування напрямних: 1/2, 2/23, 3/30, 4/37, 5/44, 6/50, 7/60, 8/67, 9/76
\end{mybox}
