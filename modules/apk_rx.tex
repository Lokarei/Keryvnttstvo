\begin{table}[H]
  ...
  \caption{Перелік деталей шасі}
    \begin{tabular}{|p{0.8cm}|p{3.2cm}|p{7.5cm}|p{2cm}|} 
       ...
       17 & ЕПМ7.001.017 & Екран КР АПК-RX SCHROFF & 1 од. \\ \hline
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.0\textwidth]{images/A64.png} 
   % \caption{ОРІОН АПК RX}
\end{figure}
\begin{figure}[H]
    \centering
    % Переконайтеся, що файл зображення завантажений в Overleaf
    \includegraphics[width=1.0\textwidth]{images/A8.png} 
    \caption{ОРІОН АПК RX}
\end{figure}

\begin{mybox}{Важливо}
Розташування екранів:1/6, 2/43, 3/56, 4/69
\end{mybox}

\begin{mybox}{Важливо}
Розташування напрямних:1/3, 2/9, 3/16, 4/23, 5/30, 6/37, 7/47, 8/59, 9/64, 10/72
\end{mybox}
